...
#linux =1 or windows =2
runOS <- 1
#linux data directory first option, windows second option
DDdir <- c("/home/hkropp/boreal/data",
				"z:\\projects\\boreal_swe_depletion\\data")
...
#need pixID, original cell id, year, gcID, original zone id, lat, long, canopy cover
